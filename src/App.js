...
const App = () => {
  ...
  const [animalState, setanimalState] = useState(JSON.parse(localStorage.getItem("animals")));
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/profile' element={<Profile LoggedIn={LoggedIn} User={User} animalState={animalState} setanimalState={setanimalState} setupdate={setupdate} />} />
      <Route path='/update' element={<Update update={update} submitUpdate={submitUpdate} />} />
    </Routes>
